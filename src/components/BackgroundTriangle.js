...
console.log('PROPS.T:',this.props.transform);
    ...
    return <svg  xmlns="http://www.w3.org/2000/svg" style={style} viewBox="0 0 1 1"
        data={this.props.transform+this.props.colourSecondary}>
      <g transform={this.props.transform}>
        <path fill={colourPrimary} d="m0,0 l1,1 l0,-1 z" />
        {(this.props.colourSecondary === undefined) ?
          null
          : <path fill={this.props.colourSecondary} d="m0,0 l10,1 l-1,0 z" />}
      </g>
    </svg>
  }
}
